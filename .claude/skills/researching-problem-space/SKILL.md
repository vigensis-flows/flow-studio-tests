...
description: Researches the problem space and market opportunity for a product idea. Produces the problem-and-opportunity analysis file. Triggers: "research opportunity", "analyze problem space", "market analysis".
---
...
4. Check for `docs/product-brief/provided-materials-digest.md` — if it exists, use it as a starting point
